...
export type WorkflowOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"workflowId" | "workspaceId" | "name" | "description" | "status" | "triggerType" | "triggerConfig" | "createdAt" | "updatedAt", ExtArgs["result"]["workflow"]>
...
export interface WorkflowDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const workflowWithWorkflowIdOnly = await prisma.workflow.findMany({ select: { workflowId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Workflows and only return the `workflowId`
   * const workflowWithWorkflowIdOnly = await prisma.workflow.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Workflows and only return the `workflowId`
   * const workflowWithWorkflowIdOnly = await prisma.workflow.updateManyAndReturn({
   *   select: { workflowId: true },
   *   where: {
   *     // ... provide filter here
   *   },
