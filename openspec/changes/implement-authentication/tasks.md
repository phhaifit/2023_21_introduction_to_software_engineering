...
- [ ] 1.1 Define user, credential, and session/token data model or repository interfaces inside `backend/src/modules/authentication`
...
- [ ] 2.2 Wire authenticated request parsing into `backend/src/shared/auth/request-context.ts`
- [ ] 2.3 Return shared API success and error response shapes for all authentication endpoints

## 3. Frontend Experience

- [ ] 3.1 Build registration, login, and logout UI flows in `frontend/src/features/authentication`
