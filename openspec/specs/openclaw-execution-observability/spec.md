...
## Purpose
Defines the requirements for projection-only observability, graceful degradation, event-scoping isolation, automated security redaction, and external metadata dependencies within OpenClaw task execution.
