...
## Purpose
Defines the `TaskExecutionAdapter` port interface as the provider-neutral consumer-side boundary for managing runtime execution lifecycle operations, command validation, execution bindings, normalized events, and secure error contracts.
