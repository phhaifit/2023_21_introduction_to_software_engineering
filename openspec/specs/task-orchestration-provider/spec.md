# task-orchestration-provider Specification

## Purpose
Covers the TaskOrchestrationClient contract, TaskRuntimeEvent discriminated union, ProviderConfig selection, MockTaskOrchestrationProvider adapter fidelity, HttpTaskOrchestrationProvider boundary, and runtime ownership anchored to Task ID.
