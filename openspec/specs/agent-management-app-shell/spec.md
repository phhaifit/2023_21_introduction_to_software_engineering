...
Define the browser-runnable Agent Management app shell used for local visual inspection before backend API, persistence, RBAC, or OpenClaw integration exists.
