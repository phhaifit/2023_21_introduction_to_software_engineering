...
| `GET` | `/api/workspaces/:workspaceId/agents/models` | Workspace member | Route `workspaceId` | Request context | `ApiResponse` model catalog entries | `planned` | Reserved for static server-side model catalog in the creation assistant change. |
