...
const expectedRoutes = [
  ...
  ["PATCH", "/api/workspaces/:workspaceId/invitations/:invitationId", "planned"],
  ["DELETE", "/api/workspaces/:workspaceId/invitations/:invitationId", "planned"],
  ["PATCH", "/api/workspaces/:workspaceId/members/:memberId", "planned"],
  ["POST", "/api/workspaces/:workspaceId/members/:memberId/transfer-host", "planned"],
